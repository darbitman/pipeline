...
class PriorityQueue : public QueueInterface<_Tp>
{
  public:
     ...
     */
    explicit PriorityQueue(size_t initialCapacity);
...
PriorityQueue<_Tp, _ComparatorType>::PriorityQueue(size_t initialCapacity) : N_(0)
{
...
template <typename _Tp, typename _ComparatorType>
PriorityQueue<_Tp, _ComparatorType>::PriorityQueue() : N_(0)
{
...
template <typename _Tp, typename _ComparatorType>
PriorityQueue<_Tp, _ComparatorType>::~PriorityQueue()
{
}

template <typename _Tp, typename _ComparatorType>
inline void PriorityQueue<_Tp, _ComparatorType>::resetPriorityQueue()
{
    N_ = 0;
}

template <typename _Tp, typename _ComparatorType>
void PriorityQueue<_Tp, _ComparatorType>::push(const _Tp& element)
{
...
template <typename _Tp, typename _ComparatorType>
void PriorityQueue<_Tp, _ComparatorType>::push(_Tp&& element)
{
    // if the heap_ is at capacity
    // N_ is the index while size() returns the number of elements which will always be one more
    // than the index, need to subtract 1
...
template <typename _Tp, typename _ComparatorType>
void PriorityQueue<_Tp, _ComparatorType>::pop()
{
...
template <typename _Tp, typename _ComparatorType>
const _Tp& PriorityQueue<_Tp, _ComparatorType>::top() const
{
    return heap_[1];
}

template <typename _Tp, typename _ComparatorType>
size_t PriorityQueue<_Tp, _ComparatorType>::size() const
{
    return N_;
}

template <typename _Tp, typename _ComparatorType>
bool PriorityQueue<_Tp, _ComparatorType>::empty() const
{
    return N_ == 0;
}

template <typename _Tp, typename _ComparatorType>
void PriorityQueue<_Tp, _ComparatorType>::swim(uint32_t k)
{
...
template <typename _Tp, typename _ComparatorType>
void PriorityQueue<_Tp, _ComparatorType>::sink(uint32_t k)
{
    while (2 * k <= N_)
    {
        uint32_t j = 2 * k;
...
template <typename _Tp, typename _ComparatorType>
void PriorityQueue<_Tp, _ComparatorType>::exch(uint32_t j, uint32_t k)
{
    _Tp swap = heap_[j];
    heap_[j] = heap_[k];
    heap_[k] = swap;
